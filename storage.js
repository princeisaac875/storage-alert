(function() {
    ...
    const alertHTML = `
        <div class="storage-alert" style="padding:10px;">
            <div class="storage-alert-title" style="margib-bottom: 10px; gap:10px; font-size: 18px;">
            ...
            <div class="storage-alert-content">
                <div class="storage-alert-message" style="margin-bottom:10px;">
                    You have used <strong>95% of your 100 GB</strong> storage space. Issues such as data loss, server restart, application crash, or scheduled tasks not running may occur.
                </div>
